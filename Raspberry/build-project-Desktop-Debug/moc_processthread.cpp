...
QT_MOC_LITERAL(1, 14, 8), // "setValue"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 4), // "temp"
QT_MOC_LITERAL(4, 29, 3), // "hum"
QT_MOC_LITERAL(5, 33, 4), // "dust"
QT_MOC_LITERAL(6, 38, 5) // "human"

    },
    "processThread\0setValue\0\0temp\0hum\0dust\0"
    "human"
};
...
void processThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setValue((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< int(*)>(_a[4]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (processThread::*)(int , int , int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&processThread::setValue)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void processThread::setValue(int _t1, int _t2, int _t3, int _t4)
{
